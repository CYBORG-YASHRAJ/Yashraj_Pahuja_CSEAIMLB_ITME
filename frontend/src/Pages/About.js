...
const About = () => {
    ...
    return (
        <div style={containerStyle}>
            <h1 style={headerStyle}>About INNOVATIVE TRENDS IN MULTIDISCIPLINARY ENGINEERING (ITME)</h1>
            <p style={paragraphStyle}>
                INNOVATIVE TRENDS IN MULTIDISCIPLINARY ENGINEERING (ITME) is an international, peer-reviewed online journal published bi-monthly. Our mission is to provide a platform for genuine and reliable contributions to the scientific community through our Scholarly Open Access Initiative.
            </p>
            <p style={paragraphStyle}>
